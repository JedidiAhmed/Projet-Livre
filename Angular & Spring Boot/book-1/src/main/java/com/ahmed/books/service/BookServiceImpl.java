...
public class BookServiceImpl implements BookService{
	...
	//objet pour CRUD
	BookRepository livreRepository;
	...
	@Override
	public List<Book> findByAuteurLivreContains(String auteurLivre) {
		return livreRepository.findByAuteurLivreContains(auteurLivre);
	}
