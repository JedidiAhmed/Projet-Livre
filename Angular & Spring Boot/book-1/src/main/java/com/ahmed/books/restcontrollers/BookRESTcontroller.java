...
public class BookRESTcontroller {
	...
	@RequestMapping(value="/livsauteur/{auteurLivre}",method = RequestMethod.GET)
	public List<Book> findByAuteurLivreContains(@PathVariable("auteurLivre") String auteurLivre) {
	return livreService.findByAuteurLivreContains(auteurLivre);
	}
